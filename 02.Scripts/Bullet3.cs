...
public class Bullet3 : MonoBehaviourPun
{
    private Transform target;

    public float speed = 70f;
    public float explosionRadius = 0f;
    public Object impactEffect3;
    public int Dmages;
    ...
    void HitTarget()
    {
        ...
        GameObject effectIns3 = PhotonNetwork.Instantiate(impactEffect3.name, transform.position, transform.rotation);
        Destroy(effectIns3, 2f);
